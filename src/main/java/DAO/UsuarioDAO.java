...
public class UsuarioDAO extends usuarioService {
    ...
    public static final String SQL_ACTUALIZAR = "UPDATE mascotas SET tipoDocumento = ?, numeroDocumento = ?," +
    ...
    public List<Usuario> consultar() {
        ...
        try {
            ...
            while (res.next()) {
                String tipoDocumento = res.getString("id");
                String numeroDocumento = res.getString("nombre");
                String nombre = res.getString("fechanacimiento");
                String apellido = res.getString("raza");
                String email = res.getString("color");
                String telefono = res.getString("propietario_numerodocumento");
                String password = res.getString("propietario_numerodocumento");
                Usuario = new Usuario(tipoDocumento, numeroDocumento, nombre, apellido, email, telefono, password);
    ...
    @Override
    public int eliminar(Usuario mascota) {
        Connection con = null;
        PreparedStatement stmt = null;
        int registros = 0;
        try {
